// scripts/repairSubscriptionsFromPreviewV6.js
...
//   node scripts/repairSubscriptionsFromPreviewV6.js --period=2026-09
//   node scripts/repairSubscriptionsFromPreviewV6.js --period=2026-09 --apply
//
// Opcional:
...
async function main() {
  ...
  try {
    ...
    if (!apply) {
      ...
      console.log(
        `node scripts/repairSubscriptionsFromPreviewV6.js --period=${periodKey} --apply`
      );
      return;
    }
