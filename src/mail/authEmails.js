...
export async function sendVerifyEmail(user, verifyUrl) {
  // Toda verificación usa un único template de registro/verificación.
  return sendUserRegistrationReceivedEmail(user, verifyUrl);
}
              ...
              <tr>
                ...
                >
                  ...
                  >
                    ...
                    ${renderUnifiedMailFooter({ className: "duo-reg-footer" })}
                  </table>
                </td>
              </tr>
            </table>
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" class="duo-admin-reg-wrap" style="max-width:430px; border-collapse:separate; border-spacing:0;">
            <tr><td class="duo-admin-reg-card" style="background:#FBFBFB; border-radius:0 0 28px 28px; overflow:hidden; font-family:Arial, Helvetica, sans-serif; color:#111111;">
              <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; width:100%;">
                        ...
                        <td style="padding:0 0 14px;">
                          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;">
                            <tr>
                              ...
                              <td class="duo-admin-reg-heading" valign="middle" style="font-size:24px; line-height:28px; font-weight:750; color:#111111; letter-spacing:-0.6px;">Nuevo registro</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
                ...
                ${renderUnifiedMailFooter({ className: "duo-admin-reg-footer" })}
              </table>
            </td></tr>
          </table>
        </td></tr>
              ...
              <tr>
                ...
                >
                  ...
                  >
                    ...
                    ${renderUnifiedMailFooter({ className: "duo-account-footer" })}
                  </table>
                </td>
              </tr>
            </table>
